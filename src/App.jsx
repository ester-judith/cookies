    ...
    <div className="main">
      ...
      <div className="content">
          ...
          <table>
            ...
            <tbody>
              {cookiesArray.length > 0 &&
                cookiesArray.map((cookies, index) => (
                  <tr key={index}>
                    <td>{cookie[0]}</td>
                    <td>{cookie[0]}</td>
                    <td>
        ...
        <div className="actions">
          <div>
            <span>Name:</span>
            <input name="name" value={token.name} onChange={handleChange} type="text" placeholder="Required.." />
          </div>
          <div>
          <span>Value:</span>
            <input name="value" value={token.value} onChange={handleChange} type="text" placeholder="Required.." />
          </div>
      ...
      <div className="footer">
        <a href="https://story.com/food">Food illustrations by Storyset</a>
      </div>
    </div>
  );
